...
<div class="card">
    <div class="card-body">
        {!! Form::model($convocatoria,['route' => ['admin.convocatoria.update',$convocatoria],'autocomplete'=>
        'off','files'=>
        true,'method'=> 'put',]) !!}
        ...
        <div class="form-group">
            ...
            {!! Form::text(' name', $convocatoria->name, ['placeholder'=> 'ingrese nombre' , 'class' => 'form-control'])
            !!}
            @error('name')
        ...
        <div class="row mb-3">
            <div class="col">
                <div class="img-wrapper">
                    ...
                    <img id="picture" src="{{Storage::url($convocatoria->image->url)}}" alt="{{$convocatoria->name}}">
                    @else
        ...
        <div class="col">
            ...
            <a target="_blank" href="{{Storage::url($convocatoria->archivo->url)}}">Ver archivo</a>
