        ...
        <div
            ...
            <div class="flex items-center gap-2">
                <a href="https://www.quibdo-choco.gov.co/Paginas/default.aspx" target="_blank" rel="noopener noreferrer"
                    class="flex">
                    <img src="{{ Vite::asset('resources/images/logo.jpeg') }} " class=" w-[60px]">
            ...
            <ul
                ...
                <li x-data="{openDesple:false}" class="relative">
                    ...
                    <div x-show="openDesple" x-on:click.away="openDesple=false"
                        ...
                        <ul class="py-1 text-sm text-gray-700">
                            ...
                            <li>
                                <a href=""
                                    class="block px-4 py-2 hover:bg-light_green hover:text-white rounded-md">Planes
                                </a>
                            </li>
                            <li>
                                <a href="" class="block px-4 py-2 hover:bg-light_green hover:text-white rounded-md">
                                    Programas
                                </a>
                            </li>
                            <li>
                                <a href=""
                                    class="block px-4 py-2 hover:bg-light_green hover:text-white rounded-md">Documentos
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li>
                    <a href="https://www.quibdo-choco.gov.co/Transparencia/Paginas/Transparencia-y-Acceso-a-la-Informacion-Publica.aspx"
                        target="_blank"
                        class="{{request()->routeIs('pages.transparencia') ? 'font-bold text-light_green' : '' }} block py-2 pl-3 pr-4  rounded  md:hover:bg-transparent hover:text-light_green md:p-0 hover:font-medium text-gray-700">Transparencia</a>
                </li>
                        ...
                        <ul class="py-1 text-sm text-gray-700">
                            ...
                            <li>
                                <a href={{route('pages.objetivo')}}
                                    class="block px-4 py-2 hover:bg-light_green hover:text-white rounded-md">Objetivos
                                </a>
                            </li>
                            <li>
                                <a href={{route('pages.estructura')}}
                                    class="block px-4 py-2 hover:bg-light_green hover:text-white rounded-md">Estructura
                                </a>
                            </li>
